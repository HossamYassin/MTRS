...
namespace MTRS.DAL.Migrations
{
    ...
    [Migration("20210712085329_ApprovalManagerName")]
    partial class ApprovalManagerName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MTRS.Core.Entities.BaseActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MTRS.Core.Entities.Grade", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("MTRS.Core.Entities.Activity", b =>
                {
                    b.HasOne("MTRS.Core.Entities.BaseActivity", "BaseActivity")
                        .WithMany()
            ...
            modelBuilder.Entity("MTRS.Core.Entities.User", b =>
                {
                    ...
                    b.HasOne("MTRS.Core.Entities.Grade", "Grade")
                        .WithMany()
